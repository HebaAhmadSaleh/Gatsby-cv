          ...
          <LeftContainer>
            ...
            <Section>
              ...
              <div style={{ display: "flex", flex: 1 }}>
                ...
                <SocialCell>
                  <FaTwitter
                    onClick={() => this.goTo("https://twitter.com/hebaAsaleh")}
                    color="#329CC3"
                    style={{ marginRight: 6 }}
                  />
                </SocialCell>
          ...
          <RightContainer>
            <Section>
              ...
              <p>
                ...
                Engineer to utilize my educational background and to gain
                experience.
              </p>
            </Section>
            <Section>
              ...
              <div style={{ display: "flex", flex: 1 }}>
                <div style={{ display: "flex" }}>
                  <ul style={{ flex: 1 }}>
                    ...
                    <li> TypeScript </li>
                    <li> Webpack </li>
                    <li> SEO tools (Google Analytics)</li>
                    <li> customer satisfaction tools (wootric)</li>
                    <li> events tracking tools (Mixpanel)</li>
                    <li>AJAX </li>
                    <li>JQuery </li>
                  </ul>
                  <ul style={{ flex: 1 }}>
